...
All components of the Software Deployment Registry will be deployed using containerization, following infrastructure-as-code principles. No direct physical installation of software will be used.
